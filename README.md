...
1. [Задание 1](Seminar_7/task7_1.py)
...
2. [Задание 2](Seminar_7/task7_2.py) 
    - Напишите функцию, которая генерирует псевдоимена.
    - ✔ Имя должно начинаться с заглавной буквы, состоять из 4-7 букв, среди которых обязательно должны быть гласные.
    - ✔ Полученные имена сохраните в файл

3. [Задание 3](Seminar_7/task7_3.py)
...
4. [Задание 4](Seminar_7/task7_4.py)
...
5. [Задание 5](Seminar_7/task7_5.py)
...
6. [Задание 6](Seminar_7/task7_6.py)
...
7. [Задание 7](Seminar_7/task7_7.py)
