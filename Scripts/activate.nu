...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Python_advanced\Python_advanced'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Python_advanced\Python_advanced\Scripts\deactivate.nu'
